...
namespace Drupal\itkore_frontpage_header\Form;
...
/**
 * Class ItkoreFrontpageHeaderSettingsForm
 *
 * @package Drupal\itkore_admin\Form
 */
class ItkoreFrontpageHeaderSettingsForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'itkore_frontpage_header_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['frontpage_wrapper']['frontpage_title'] = array(
      '#title' => $this->t('Title'),
      '#type' => 'textfield',
      '#default_value' => $config->get('frontpage_title'),
      '#weight' => '1',
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->getBaseConfig()->setMultiple(array(
      'frontpage_title' => $form_state->getValue('frontpage_title'),
